...
# UI
st.title("📚 法文單字遊戲 / French Vocabulary Game")
...
num_questions = st.number_input("輸入測試題數 / Number of questions:", min_value=1, max_value=len(word_data), value=len(word_data), step=1)
